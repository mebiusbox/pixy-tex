...
\pgfkeys{%
	...
	frame/.default=yes,
	eval/caption/.code={\ifstrempty{#1}{}{\caption{#1}}},
	eval/label/.code={\ifstrempty{#1}{}{\label{#1}}},
	eval/image/.code n args={2}{
		\ifthenelse{\equal{#1}{}}{
			\includegraphics[]{#2}
		}{
...
\NewDocumentCommand \Image{o m m m m}{%
	\pgfkeys{/pixy/image/.cd, size, frame=no}%
	...
	\begin{figure}[#2]%
		...
		\ifthenelse{\equal{\pixy@image@frame}{yes}}{%
    		...
    		\fboxrule=0.5pt%
			\fbox{%
				\pgfkeys{/pixy/image/eval/image={\pixy@image@width}{#3}}
			}%
			\fboxsep=\fb@xsep%
    		\fboxrule=\fb@xrule%
		}{
		...
		\pgfkeys{/pixy/image/eval/caption={#4}}%
		\pgfkeys{/pixy/image/eval/label={#5}}%
	\end{figure}%
}
\makeatother
%------------------------------------------------------------
